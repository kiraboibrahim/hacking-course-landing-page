...
function Navigation({ scrolled, onEnrollClick }: NavigationProps) {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                <div className="flex justify-between items-center py-4">
                    ...
                    <div className="hidden md:flex items-center gap-6">
                        ...
                        <button onClick={() => scrollToSection('instructor')} className="text-gray-300 hover:text-pink-400 transition-colors font-bold">Instructor</button>
                ...
                {showMobileMenu && (
                    <div className="md:hidden pb-4 space-y-3 mobile-menu-enter">
                        ...
                        <button onClick={() => scrollToSection('instructor')} className="block w-full text-left text-gray-300 hover:text-pink-400 transition-colors font-bold py-2">Instructor</button>
                    </div>
                )}
            </div>
        </nav>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto px-4">
            {stats.map((stat, index) => (
                <div key={index} className="relative group">
                    <div className={`absolute inset-0 bg-gradient-to-r ${stat.gradient} rounded-xl blur opacity-30 group-hover:opacity-50 transition-opacity`}></div>
                    <div className={`relative bg-black border-2 border-${stat.color}-400 rounded-xl p-6 sm:p-8 hover:scale-105 transition-transform`}>
                        <stat.icon
                            className={`mx-auto mb-3 sm:mb-4 text-${stat.color}-400 ${stat.animation}`}
                            style={stat.animationDuration ? { animationDuration: stat.animationDuration } : {}}
                            size={40}
                        />
                        <div className={`text-3xl sm:text-4xl font-black text-${stat.color}-400 mb-2`}>{stat.value}</div>
                        <div className="text-sm sm:text-base text-gray-400 font-bold">{stat.label}</div>
                    </div>
                </div>
            ))}
        </div>
...
// Week Card Component
function WeekCard({ week, isActive, onClick }: WeekCardProps) {
    return (
        <div className="relative group">
            ...
            <div className="relative bg-black border-2 border-purple-500 group-hover:border-pink-400 rounded-xl overflow-hidden transition-all duration-300">
                ...
                >
                    ...
                    <ChevronDown
                        className={`text-pink-400 flex-shrink-0 transition-transform duration-300 ${isActive ? 'rotate-180' : ''}`}
                        size={28}
                    />
                </button>
...
function InstructorSection() {
    return (
        <div id="instructor" className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
            <div className="text-center mb-12 sm:mb-16">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400">
                    MEET YOUR INSTRUCTOR
                </h2>
                <p className="text-gray-400 text-lg sm:text-xl font-bold">// LEARN FROM A CERTIFIED EXPERT</p>
            </div>
            ...
            <div className="relative group max-w-4xl mx-auto">
                ...
                <div className="relative bg-black border-2 border-purple-500 group-hover:border-cyan-400 rounded-2xl overflow-hidden transition-all duration-300">
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-6 sm:gap-8 p-6 sm:p-8">
                        <div className="md:col-span-2 flex justify-center items-start">
                            <div className="relative w-full max-w-xs">
                                <div className="absolute inset-0 bg-gradient-to-r from-pink-500 to-cyan-500 rounded-xl blur opacity-50"></div>
                                <div className="relative rounded-xl border-4 border-cyan-400 overflow-hidden">
                                    <Image
                                        src="/profile.jpeg"
                            ...
                            <div className="space-y-3 mb-6">
                                <div className="flex items-start gap-3">
                                    ...
                                    <p className="text-gray-300 text-sm sm:text-base">
                                        <span className="text-pink-400 font-bold">Software Engineer</span> with extensive industry experience
                                    </p>
                                </div>
                                <div className="flex items-start gap-3">
                                    <div className="w-2 h-2 bg-cyan-400 rounded-full flex-shrink-0 mt-2"></div>
                                    <p className="text-gray-300 text-sm sm:text-base">
                                        <span className="text-pink-400 font-bold">Certified Linux System Administrator</span>
                                    </p>
                                </div>
                                <div className="flex items-start gap-3">
                                    <div className="w-2 h-2 bg-cyan-400 rounded-full flex-shrink-0 mt-2"></div>
                                    <p className="text-gray-300 text-sm sm:text-base">
                                        <span className="text-pink-400 font-bold">Proud Finalist</span> of the 3rd Edition UCC CyberStars Competition
                                    </p>
                                </div>
                            </div>

                            <div className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border-2 border-cyan-400 rounded-lg p-4">
    ...
    return (
        ...
        >
            ...
            <div className="relative bg-black border-2 border-purple-500 group-hover:border-pink-400 rounded-xl p-6 sm:p-8 transition-all duration-300 transform group-hover:scale-105">
                <skill.icon
                    className={`mb-4 transition-all duration-300 ${isHovered ? 'text-pink-400 scale-125' : 'text-cyan-400'}`}
                    size={40}
                />
...
function CTASection({ onEnrollClick }: { onEnrollClick: () => void }) {
    return (
...
export default function CyberpunkLanding() {
    ...
    return (
        <div className="min-h-screen bg-black text-white overflow-hidden relative">
            ...
            <Navigation scrolled={scrolled} onEnrollClick={handleEnrollClick} />
            ...
            <Footer />
            <ScrollToTopButton show={scrolled} />
        </div>
    );
}